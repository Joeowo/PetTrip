...
from pilot4mvp2.agent_service.chat_provider import ChatMessage, OpenAICompatibleChatProvider
from pilot4mvp2.agent_service.structured_output import StructuredOutputRegistry
